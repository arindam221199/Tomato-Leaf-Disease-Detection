...
filepath = 'D:\Projects\ML project\Tomato_leaf_disease_detection\model.h5'
model = load_model(filepath)
print(model)

print("Model Loaded Successfully")

tomato_plant = cv2.imread('D:/Projects/ML project/Tomato_leaf_disease_detection/Dataset/test/Tomato___Bacterial_spot (1).JPG')
